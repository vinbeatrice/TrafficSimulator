...
EPSILON_DECAY = 1350000 #con 9000 episodi ha ottenuto 197.0, quindi l'unico errore che ha fatto è stato fermarsi un paio di volte a caso. è arrivato con epsilon a 0.02 al 9000 episodio
