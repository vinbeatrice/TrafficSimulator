...
env = PathEnv(grid_map=map, path=PATHS[5], fov=(FOV_W, FOV_H), render_mode=RENDER_MODE_TEST, max_steps=MAX_STEPS, num_npc=30, npc_policy_path=NPC_PATH)
print("ENV created")
obs, _ = env.reset()
#print(obs)
...
agent.policy_net.load_state_dict(torch.load("weights/proj_aware_1v30_weights.pt", map_location=device))
